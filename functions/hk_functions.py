...
# %%
#Import functions
from functions.common_functions import own_account_allowed, pop_judgment, convert_df_to_json, convert_df_to_csv, convert_df_to_excel, clear_cache, list_value_check, list_range_check, save_input, date_parser, pdf_image_judgment, docx_judgment, str_to_int
#Import variables
    ...
    def attach_judgment_text_and_urls(self, case_info):
        ...
        if len(judgment_text) == 0:
            ...
            try:
                ...
                judgment_text = pdf_image_judgment(pdf_url)
