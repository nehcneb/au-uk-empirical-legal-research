...
#    sdf = SmartDataframe(st.session_state.edited_df, config = {'llm': llm})
    ...
    st.caption('During the pilot stage, the number of questions and the number of characters per question are capped. Please reach out to Ben at ben.chen@sydney.edu.au should you wish to ask more questions or longer questions.')

    # Generate output

    st.warning('A low-cost AI will respond to your question(s). Please be cautious.')
