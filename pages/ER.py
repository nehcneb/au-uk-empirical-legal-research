...
You may enter at most 1000 characters here.
    ...
    st.caption("Answers to your questions will be generated by model gpt-3.5-turbo-0125. Due to a technical limitation, the model will be instructed to 'read' up to approximately 10,000 words from each judgment.")
