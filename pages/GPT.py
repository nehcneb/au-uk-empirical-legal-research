...
#Import variables
from functions.gpt_functions import question_characters_bound, system_characters_bound, default_caption, basic_model, flagship_model, role_content, gpt_system_msg, pages_w_batch, default_temperature, default_reasoning_effort, gpt_models_list, gpt_reasoning_models_list, reasoning_effort_list, gpt_stats
#, intro_for_GPT
...
if own_account_allowed() == 0:
    ...
    st.markdown("""Would you like to improve the quality and accuracy of answers from GPT, or change the maximum number of cases to process? You can do so with your own OpenAI account.
""")
