...
st.subheader("Enter your question(s) for each file")

st.markdown("""GPT will answer your question(s) for **each** file based only on information from **that** file. 
...
st.caption(f"By default, answers to your questions will be generated by model gpt-3.5-turbo-0125. Due to a technical limitation, this model will read up to approximately {round(tokens_cap('gpt-3.5-turbo-0125')*3/4)} words from each file.")
