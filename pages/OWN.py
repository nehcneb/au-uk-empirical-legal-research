...
""")
    ...
    st.markdown("""The following file formats are supported: **PDF**, **TXT**, XPS, EPUB, MOBI, FB2, CBZ, SVG. :red[(Microsoft Word documents are not yet supported.)]
    """)
...
""")
    ...
    st.markdown("""**:red[After your files have been uploaded,] you can run the Empirical Legal Research Kickstarter.** A spreadsheet which hopefully has the data you seek will be available for download in about 2-3 minutes.
